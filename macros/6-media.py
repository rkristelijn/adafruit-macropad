...
app = {               # REQUIRED dict, must be named 'app'
    'name' : '6: Adafruit Media  ', # Application name
    'macros' : [      # List of button macros...
        # COLOR    LABEL    KEY SEQUENCE
        # 1st row ----------
        (0x000000, 'Eject', [[ConsumerControlCode.EJECT]]),
        (0x000000, 'Vol+', [[ConsumerControlCode.VOLUME_INCREMENT]]),
        (0x000000, 'Bright+', [[ConsumerControlCode.BRIGHTNESS_INCREMENT]]),
        # 2nd row ----------
        (0x000000, '', []),
        (0x000000, 'Vol-', [[ConsumerControlCode.VOLUME_DECREMENT]]),
        (0x000000, 'Bright-', [[ConsumerControlCode.BRIGHTNESS_DECREMENT]]),
        # 3rd row ----------
        (0x000000, '', []),
